...
import com.codejies.sortview.R;
...
public class SortView extends HorizontalScrollView implements View.OnClickListener {
    ...
    public RelativeLayout generalRelativeLayout(String text){
        ...
        tv.setTextSize(Tool.px2sp(getContext(),TEXT_SIZE));
    ...
    public SortView.notifyOutsideListener getNotifyOutsideListener() {
        return notifyOutsideListener;
    }

    public void setNotifyOutsideListener(SortView.notifyOutsideListener notifyOutsideListener) {
